...
def oracle_revert_database(configFile = None, fs_map_hash = None, headers = None, latest = None, snapshot = None, oracleSid = None, preview = None, project = None, region = None, url = None):
    ...
    if not preview:
        ...
        print('"startup mount;" simulated for oracle_sid %s' % (oracleSid))
        print('"recover automatic;"  simulated for oracle_sid %s' % (oracleSid))
        print('"alter database open;"  simulated for oracle_sid %s' % (oracleSid))
